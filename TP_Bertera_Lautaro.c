...
//      Sume una libreria que no vimos en clase "<stdlib.h>" lo aprendi por mi cuenta.( cuando ingresas usuario puse que se limpie la consola, queda bien) y tenia que incluir esta biblioteca sino tiraba un warning. Tambien <ctype.h> para que guarde el char en mayuscula.
...
void agregarComen(struct comentario comentarios[], int contadorComen){
    ...
    while (aux.codigoEvento > 9999) {
        printf("Error en ingreso!!!\nEl numero tiene que ser de 4 digitos maximo.\n\tNuevo intento\n\n Ingrese codigo de evento en numeros enteros hasta 4 digitos:\n");
        scanf("%d", &aux.codigoEvento);
    }
    ...
    while(aux.fechaEvento.dia>31){
        printf("\nError en ingreso!!!\nEl numero tiene que ser menor o igual que 31.\n\n\n\n\tNuevo intento\nIngrese dia:\n ");
        scanf("%d",&aux.fechaEvento.dia);
    }

    printf("Ingrese mes\n");
    scanf("%d",&aux.fechaEvento.mes);
    while(aux.fechaEvento.mes>12){
        printf("\nError en ingreso!!!\nEl numero tiene que ser menor o igual que 12.\n\n\n\n\tNuevo intento\nIngrese mes:\n ");
        scanf("%d",&aux.fechaEvento.mes);
    }

    printf("Ingrese anio\n");
    scanf("%d",&aux.fechaEvento.anio);
    while(aux.fechaEvento.anio>=2023){
        printf("\nError en ingreso!!!\nEl anio tiene que ser menor o igual que 2023.\n\n\n\n\tNuevo intento\nIngrese anio:\n ");
        scanf("%d",&aux.fechaEvento.anio);
    }
    ...
    aux.atencion = toupper(aux.atencion);//implemente para que no tenga errores toupper para que la guarde ya en mayuscula

    printf("Ingrese la calificacion del servicio en formato numero entero del 1 al 10\n");
    scanf("%d",&aux.clasificacion);
    while(aux.clasificacion>10){
        printf("\nError en ingreso!!!\nLa calificacion tiene que ser un numero entero del 1 al 10.\n\n\n\n\tNuevo intento\nIngrese calificacion:\n ");
        scanf("%d",&aux.clasificacion);
    }
